...
export default function Personalization1Screen() {
  ...
  const options = [
    ...
    "I need help with daily motivation",
    "I want to build better habits",
    "I'm seeking emotional support",
    "I want to explore mindfulness",
  ];

  const handleContinue = () => {
    if (selectedOption) {
      router.push("/onboarding/personalization-2" as any);
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.question}>What brings you to Melo?</Text>
        <ScrollView
